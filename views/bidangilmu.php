                ...
                <tbody>
                    ...
                    if (isset($_POST['type'])) {
                        if ($_POST['type'] == "delete") {
                            $b->delete($_POST['id']);
                            echo '<script>alert("hapus berhasil")</script><meta http-equiv="refresh" content="0; url=?url=bidangilmu">';
                            ...
                            echo '<script>alert("tambah berhasil")</script><meta http-equiv="refresh" content="0; url=?url=bidangilmu">';
                        } elseif ($_POST['type'] == "update") {
                            $data = [
                                'nama' => $_POST['nama'],
                                'deskripsi' => $_POST['deskripsi'],
                            ];
                            $bidangIlmu->update($_POST['id'], $data);
                            echo '<script>alert("update berhasil")</script><meta http-equiv="refresh" content="0; url=?url=bidangilmu">';
                        }
                    }
                    ?>
                </tbody>
